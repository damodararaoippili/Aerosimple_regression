...
class AWO_send_back_maintenance:
    ...
    def verify_work_order_status(self):
        ...
        for work_order in all_work_orders:
            ...
            if "Operations Review" in work_order_text or "In Progress" in work_order_text:
                print("                      ")
                print(f"Found work order: {work_order_text}")
                view_button = work_order.find_element(By.XPATH,".//div[contains(@class, 'workOrderList_operation') or contains(@class, 'workOrderList_maintenance_inprogress')]//span[contains(.,'Operations Review') or contains(.,'In Progress')]/../../..//td//a//span[text()='View']/..")
                view_button.click()
                break
        else:
            print("No work order with 'Operations Review' or 'In Progress' status found.")